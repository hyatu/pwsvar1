...
foreach ($share in $SharePaths) {
    ...
    $EmailParams = @{
        ...
        From        = "sharepoint-migration@yourdomain.com"
        Subject     = "Shared Folder Inventory Completed"
        Body        = "Inventory of shared folders has completed. Attached is the report."
